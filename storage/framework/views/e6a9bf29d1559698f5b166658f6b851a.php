            ...
            <tfoot>
                <tr>
                    ...
                    <th class="px-6 py-4 text-left">
                        ...
                        <th>
                            <a href="<?php echo e($basket['total']>0 ? '/paymentInformation':'/basket'); ?>"><button class="bg-lime-600 text-white px-4 py-2 rounded hover:bg-gray-gray-900 hover:cursor-pointer">acheter</button></a>
                        </th>
                </tr>
            </tfoot>
        </table>
