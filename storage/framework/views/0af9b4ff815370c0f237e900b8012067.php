...
<footer class="mt-4 p-4 flex flex-col bg-neutral-900 text-neutral-100"><Hr class="m-4 bg-white w-2/3 self-center"></Hr>
    <div class="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="gap-4 flex flex-col  justify-center md:justify-end md:flex-row">
            ...
            <div class="flex flex-col  space-y-2  md:space-y-0 mt-4 md:mt-0">
