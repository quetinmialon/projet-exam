        ...
        <div class="px-3 py-4 flex justify-center">
            <form method="POST" action="/backOffice/addProduct" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="image" id="image" accept="image/*" class="mt-1 p-2 w-full border rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                </div>
